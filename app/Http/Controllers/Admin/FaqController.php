...
class FaqController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $data->save();
        return redirect()->route('admin_faq')->with('success', 'FAQ Saved Succesfully');
    }
    ...
    public function update(Request $request, Faq $faq, $id)
    {
        ...
        $data->save();
        return redirect()->route('admin_faq')->with('success', 'FAQ Update Succesfully');
    }
    ...
    public function destroy(Faq $faq, $id)
    {
        ...
        return redirect()->route('admin_faq')->with('success', 'FAQ Deleted Succesfully');;
    }
}
